    ...
    return (
        ...
        <Grid container stackable centered columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>This address book enables any number of users to login and save their business contatcts. You can only see the contatcts you have created.</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign='center'>
            <Icon size='huge' name='checked calendar' inverted></Icon>
            <Header as='h1' inverted>Timestamped Notes</Header>
            <Header as='h3' inverted>Each time you make contact with a contact, you can write a note that summarizes the conversation. This note is saved along with a timestamp</Header>
          </Grid.Column>
        </Grid>
        </div>
    );
